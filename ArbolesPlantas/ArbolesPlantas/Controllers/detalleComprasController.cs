...
namespace ArbolesPlantas.Controllers
{
    public class detalleComprasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,id_compra,id_producto,cantidad,precioCompra,status")] detalleCompra detalleCompra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,id_compra,id_producto,cantidad,precioCompra,status")] detalleCompra detalleCompra)
        {
            if (ModelState.IsValid)
            {
